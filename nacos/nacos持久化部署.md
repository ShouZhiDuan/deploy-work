...
services:
  ...
  nacos:
    ...
    container_name: nacos.com
    environment:
      - MODE=standalone
      - TZ=Asia/Shanghai
      - LANG=en_US.UTF-8
      - SPRING_DATASOURCE_PLATFORM=mysql
      - MYSQL_SERVICE_HOST=192.168.10.24
  ...
  nv-mysql:
    ...
    volumes:
      - $PWD/conf:/etc/mysql/conf.d/my.cnf
      - $PWD/logs:/logs
...
Source Host           : 192.168.10.24:13306
Source Database       : nacos-config

Target Server Type    : MYSQL
Target Server Version : 80028
File Encoding         : 65001

Date: 2022-03-01 13:39:01
*/
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin COMMENT='config_info';
...
CREATE TABLE `his_config_info` (
  ...
  KEY `idx_did` (`data_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin COMMENT='多租户改造';

-- ----------------------------
-- Records of his_config_info
-- ----------------------------
INSERT INTO `his_config_info` VALUES ('0', '1', 'test', 'DEFAULT_GROUP', '', 0x6E616D653A0D0A202073686F757A6869, '5cc38162b8dbd3d2478d852769c11b17', '2022-03-01 04:50:42', '2022-03-01 04:50:43', 0x6E61636F73, '192.168.10.2', 'I', '');
INSERT INTO `his_config_info` VALUES ('1', '2', 'test', 'DEFAULT_GROUP', '', 0x6E616D653A0D0A202073686F757A6869, '5cc38162b8dbd3d2478d852769c11b17', '2022-03-01 04:59:11', '2022-03-01 04:59:11', null, '192.168.10.2', 'D', '');
